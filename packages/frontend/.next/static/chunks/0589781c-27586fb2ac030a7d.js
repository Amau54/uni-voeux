"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[630],{6435:function(e,t,r){r.d(t,{ET:function(){return iG},JU:function(){return s7},PL:function(){return i$},ad:function(){return ii},hJ:function(){return s8},oe:function(){return iK},qs:function(){return iX},r7:function(){return ij}});var n,s,i,a,o=r(7313),l=r(7107),u=r(1052),h=r(5311),c=r(9934),d=r(4574);r(5648);var m=r(9087).Buffer;let f="@firebase/firestore",g="4.9.3";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let tk=new ep(H.comparator),tD=new ep(H.comparator);function tR(...e){let t=tD;for(let r of e)t=t.insert(r.key,r);return t}function tx(e){let t=tD;return e.forEach((e,r)=>t=t.insert(e,r.overlayedDocument)),t}function tV(){return new tA(e=>e.toString(),(e,t)=>e.isEqual(t))}let tL=new ep(H.comparator),tM=new ev(H.comparator);function tO(...e){let t=tM;for(let r of e)t=t.add(r);return t}let tP=new ev(U);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ns{constructor(e,t,r,n){this.targetId=e,this.fromCache=t,this.Es=r,this.ds=n}static As(e,t){let r=tO(),n=tO();for(let e of t.docChanges)switch(e.type){case 0:r=r.add(e.doc.key);break;case 1:n=n.add(e.doc.key)}return new ns(e,t.fromCache,r,n)}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let np="ConnectivityMonitor";class ny{constructor(){this.No=()=>this.Bo(),this.Lo=()=>this.ko(),this.qo=[],this.Qo()}Oo(e){this.qo.push(e)}shutdown(){window.removeEventListener("online",this.No),window.removeEventListener("offline",this.Lo)}Qo(){window.addEventListener("online",this.No),window.addEventListener("offline",this.Lo)}Bo(){for(let e of(_(np,"Network connectivity changed: AVAILABLE"),this.qo))e(0)}ko(){for(let e of(_(np,"Network connectivity changed: UNAVAILABLE"),this.qo))e(1)}static v(){return"undefined"!=typeof window&&void 0!==window.addEventListener&&void 0!==window.removeEventListener}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let n_="RestConnection",nE={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery"};class nT{get $o(){return!1}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;let t=e.ssl?"https":"http",r=encodeURIComponent(this.databaseId.projectId),n=encodeURIComponent(this.databaseId.database);this.Uo=t+"://"+e.host,this.Ko=`projects/${r}/databases/${n}`,this.Wo=this.databaseId.database===eO?`project_id=${r}`:`project_id=${r}&database_id=${n}`}Go(e,t,r,n,s){let i=nv(),a=this.zo(e,t.toUriEncodedString());_(n_,`Sending RPC '${e}' ${i}:`,a,r);let o={"google-cloud-resource-prefix":this.Ko,"x-goog-request-params":this.Wo};this.jo(o,n,s);let{host:l}=new URL(a),u=(0,h.Xx)(l);return this.Jo(e,a,o,r,u).then(t=>(_(n_,`Received RPC '${e}' ${i}: `,t),t),t=>{throw T(n_,`RPC '${e}' ${i} failed with error: `,t,"url: ",a,"request:",r),t})}Ho(e,t,r,n,s,i){return this.Go(e,t,r,n,s)}jo(e,t,r){e["X-Goog-Api-Client"]="gl-js/ fire/"+y,e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach((t,r)=>e[r]=t),r&&r.headers.forEach((t,r)=>e[r]=t)}zo(e,t){let r=nE[e];return`${this.Uo}/v1/${t}:${r}`}terminate(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let nI="WebChannelConnection";class nC extends nT{constructor(e){super(e),this.c_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Jo(e,t,r,n,s){let i=nv();return new Promise((s,a)=>{let o=new d.JJ;o.setWithCredentials(!0),o.listenOnce(d.tw.COMPLETE,()=>{try{switch(o.getLastErrorCode()){case d.jK.NO_ERROR:let t=o.getResponseJson();_(nI,`XHR for RPC '${e}' ${i} received:`,JSON.stringify(t)),s(t);break;case d.jK.TIMEOUT:_(nI,`RPC '${e}' ${i} timed out`),a(new A(b.DEADLINE_EXCEEDED,"Request time out"));break;case d.jK.HTTP_ERROR:let r=o.getStatus();if(_(nI,`RPC '${e}' ${i} failed with status:`,r,"response text:",o.getResponseText()),r>0){let e=o.getResponseJson();Array.isArray(e)&&(e=e[0]);let t=e?.error;if(t&&t.status&&t.message){let e=function(e){let t=e.toLowerCase().replace(/_/g,"-");return Object.values(b).indexOf(t)>=0?t:b.UNKNOWN}(t.status);a(new A(e,t.message))}else a(new A(b.UNKNOWN,"Server responded with status "+o.getStatus()))}else a(new A(b.UNAVAILABLE,"Connection failed."));break;default:I(9055,{l_:e,streamId:i,h_:o.getLastErrorCode(),P_:o.getLastError()})}}finally{_(nI,`RPC '${e}' ${i} completed.`)}});let l=JSON.stringify(n);_(nI,`RPC '${e}' ${i} sending request:`,n),o.send(t,"POST",l,r,15)})}T_(e,t,r){let s=nv(),i=[this.Uo,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=(0,d.UE)(),o=(0,d.FJ)(),l={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},u=this.longPollingOptions.timeoutSeconds;void 0!==u&&(l.longPollingTimeout=Math.round(1e3*u)),this.useFetchStreams&&(l.useFetchStreams=!0),this.jo(l.initMessageHeaders,t,r),l.encodeInitMessageHeaders=!0;let h=i.join("");_(nI,`Creating RPC '${e}' stream ${s}: ${h}`,l);let c=a.createWebChannel(h,l);this.I_(c);let m=!1,f=!1,g=new nS({Yo:t=>{f?_(nI,`Not sending because RPC '${e}' stream ${s} is closed:`,t):(m||(_(nI,`Opening RPC '${e}' stream ${s} transport.`),c.open(),m=!0),_(nI,`RPC '${e}' stream ${s} sending:`,t),c.send(t))},Zo:()=>c.close()}),p=(e,t,r)=>{e.listen(t,e=>{try{r(e)}catch(e){setTimeout(()=>{throw e},0)}})};return p(c,d.ii.EventType.OPEN,()=>{f||(_(nI,`RPC '${e}' stream ${s} transport opened.`),g.o_())}),p(c,d.ii.EventType.CLOSE,()=>{f||(f=!0,_(nI,`RPC '${e}' stream ${s} transport closed`),g.a_(),this.E_(c))}),p(c,d.ii.EventType.ERROR,t=>{f||(f=!0,T(nI,`RPC '${e}' stream ${s} transport errored. Name:`,t.name,"Message:",t.message),g.a_(new A(b.UNAVAILABLE,"The operation could not be completed")))}),p(c,d.ii.EventType.MESSAGE,t=>{if(!f){let r=t.data[0];N(!!r,16349);let i=r?.error||r[0]?.error;if(i){_(nI,`RPC '${e}' stream ${s} received error:`,i);let t=i.status,r=function(e){let t=n[e];if(void 0!==t)return rs(t)}(t),a=i.message;void 0===r&&(r=b.INTERNAL,a="Unknown error status: "+t+" with message "+i.message),f=!0,g.a_(new A(r,a)),c.close()}else _(nI,`RPC '${e}' stream ${s} received:`,r),g.u_(r)}}),p(o,d.ju.STAT_EVENT,t=>{t.stat===d.kN.PROXY?_(nI,`RPC '${e}' stream ${s} detected buffering proxy`):t.stat===d.kN.NOPROXY&&_(nI,`RPC '${e}' stream ${s} detected no buffering proxy`)}),setTimeout(()=>{g.__()},0),g}terminate(){this.c_.forEach(e=>e.close()),this.c_=[]}I_(e){this.c_.push(e)}E_(e){this.c_=this.c_.filter(t=>t===e)}}function nN(){return"undefined"!=typeof document?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sG{constructor(e){this.observer=e,this.muted=!1}next(e){this.muted||this.observer.next&&this.Ou(this.observer.next,e)}error(e){this.muted||(this.observer.error?this.Ou(this.observer.error,e):E("Uncaught Error in snapshot listener:",e.toString()))}Nu(){this.muted=!0}Ou(e,t){setTimeout(()=>{this.muted||e(t)},0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let sQ="FirestoreClient";class sH{constructor(e,t,r,n,s){this.authCredentials=e,this.appCheckCredentials=t,this.asyncQueue=r,this.databaseInfo=n,this.user=p.UNAUTHENTICATED,this.clientId=F.newId(),this.authCredentialListener=()=>Promise.resolve(),this.appCheckCredentialListener=()=>Promise.resolve(),this._uninitializedComponentsProvider=s,this.authCredentials.start(r,async e=>{_(sQ,"Received user=",e.uid),await this.authCredentialListener(e),this.user=e}),this.appCheckCredentials.start(r,e=>(_(sQ,"Received new app check token=",e),this.appCheckCredentialListener(e,this.user)))}get configuration(){return{asyncQueue:this.asyncQueue,databaseInfo:this.databaseInfo,clientId:this.clientId,authCredentials:this.authCredentials,appCheckCredentials:this.appCheckCredentials,initialUser:this.user,maxConcurrentLimboResolutions:100}}setCredentialChangeListener(e){this.authCredentialListener=e}setAppCheckTokenChangeListener(e){this.appCheckCredentialListener=e}terminate(){this.asyncQueue.enterRestrictedMode();let e=new k;return this.asyncQueue.enqueueAndForgetEvenWhileRestricted(async()=>{try{this._onlineComponents&&await this._onlineComponents.terminate(),this._offlineComponents&&await this._offlineComponents.terminate(),this.authCredentials.shutdown(),this.appCheckCredentials.shutdown(),e.resolve()}catch(r){let t=st(r,"Failed to shutdown persistence");e.reject(t)}}),e.promise}}async function sW(e,t){e.asyncQueue.verifyOperationInProgress(),_(sQ,"Initializing OfflineComponentProvider");let r=e.configuration;await t.initialize(r);let n=r.initialUser;e.setCredentialChangeListener(async e=>{n.isEqual(e)||(await nu(t.localStore,e),n=e)}),t.persistence.setDatabaseDeletedListener(()=>e.terminate()),e._offlineComponents=t}async function sX(e,t){e.asyncQueue.verifyOperationInProgress();let r=await sY(e);_(sQ,"Initializing OnlineComponentProvider"),await t.initialize(r,e.configuration),e.setCredentialChangeListener(e=>n9(t.remoteStore,e)),e.setAppCheckTokenChangeListener((e,r)=>n9(t.remoteStore,r)),e._onlineComponents=t}async function sY(e){if(!e._offlineComponents){if(e._uninitializedComponentsProvider){_(sQ,"Using user provided OfflineComponentProvider");try{await sW(e,e._uninitializedComponentsProvider._offline)}catch(t){if(!("FirebaseError"===t.name?t.code===b.FAILED_PRECONDITION||t.code===b.UNIMPLEMENTED:!("undefined"!=typeof DOMException&&t instanceof DOMException)||22===t.code||20===t.code||11===t.code))throw t;T("Error using user provided cache. Falling back to memory cache: "+t),await sW(e,new s$)}}else _(sQ,"Using default OfflineComponentProvider"),await sW(e,new sj(void 0))}return e._offlineComponents}async function sJ(e){return e._onlineComponents||(e._uninitializedComponentsProvider?(_(sQ,"Using user provided OnlineComponentProvider"),await sX(e,e._uninitializedComponentsProvider._online)):(_(sQ,"Using default OnlineComponentProvider"),await sX(e,new sK))),e._onlineComponents}async function sZ(e){let t=await sJ(e),r=t.eventManager;return r.onListen=sE.bind(null,t.syncEngine),r.onUnlisten=sC.bind(null,t.syncEngine),r.onFirstRemoteStoreListen=sT.bind(null,t.syncEngine),r.onLastRemoteStoreUnlisten=sN.bind(null,t.syncEngine),r}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let id=/^__.*__$/;class im{constructor(e,t,r){this.data=e,this.fieldMask=t,this.fieldTransforms=r}toMutation(e,t){return null!==this.fieldMask?new t4(e,this.data,this.fieldMask,t,this.fieldTransforms):new t3(e,this.data,t,this.fieldTransforms)}}class ig{constructor(e,t,r){this.data=e,this.fieldMask=t,this.fieldTransforms=r}toMutation(e,t){return new t4(e,this.data,this.fieldMask,t,this.fieldTransforms)}}function ip(e){switch(e){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw I(40011,{Ac:e})}}class iy{constructor(e,t,r,n,s,i){this.settings=e,this.databaseId=t,this.serializer=r,this.ignoreUndefinedProperties=n,void 0===s&&this.Rc(),this.fieldTransforms=s||[],this.fieldMask=i||[]}get path(){return this.settings.path}get Ac(){return this.settings.Ac}Vc(e){return new iy({...this.settings,...e},this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}mc(e){let t=this.path?.child(e),r=this.Vc({path:t,fc:!1});return r.gc(e),r}yc(e){let t=this.path?.child(e),r=this.Vc({path:t,fc:!1});return r.Rc(),r}wc(e){return this.Vc({path:void 0,fc:!0})}Sc(e){return iR(e,this.settings.methodName,this.settings.bc||!1,this.path,this.settings.Dc)}contains(e){return void 0!==this.fieldMask.find(t=>e.isPrefixOf(t))||void 0!==this.fieldTransforms.find(t=>e.isPrefixOf(t.field))}Rc(){if(this.path)for(let e=0;e<this.path.length;e++)this.gc(this.path.get(e))}gc(e){if(0===e.length)throw this.Sc("Document fields must not be empty");if(ip(this.Ac)&&id.test(e))throw this.Sc('Document fields cannot begin and end with "__"')}}class iw{constructor(e,t,r){this.databaseId=e,this.ignoreUndefinedProperties=t,this.serializer=r||nb(e)}Cc(e,t,r,n=!1){return new iy({Ac:e,methodName:t,Dc:r,path:Q.emptyPath(),fc:!1,bc:n},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function iv(e){let t=e._freezeSettings(),r=nb(e._databaseId);return new iw(e._databaseId,!!t.ignoreUndefinedProperties,r)}function i_(e,t,r,n,s,i={}){let a,o;let l=e.Cc(i.merge||i.mergeFields?2:0,t,r,s);ib("Data must be an object, but it was:",l,n);let u=iC(n,l);if(i.merge)a=new eE(l.fieldMask),o=l.fieldTransforms;else if(i.mergeFields){let e=[];for(let n of i.mergeFields){let s=iA(t,n,r);if(!l.contains(s))throw new A(b.INVALID_ARGUMENT,`Field '${s}' is specified in your field mask but missing from your input data.`);ix(e,s)||e.push(s)}a=new eE(e),o=l.fieldTransforms.filter(e=>a.covers(e.field))}else a=null,o=l.fieldTransforms;return new im(new e4(u),a,o)}class iE extends iu{_toFieldTransform(e){if(2!==e.Ac)throw 1===e.Ac?e.Sc(`${this._methodName}() can only appear at the top level of your update data`):e.Sc(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return e.fieldMask.push(e.path),null}isEqual(e){return e instanceof iE}}function iT(e,t,r,n){let s=e.Cc(1,t,r);ib("Data must be an object, but it was:",s,n);let i=[],a=e4.empty();return ef(n,(e,n)=>{let o=iD(t,e,r);n=(0,h.m9)(n);let l=s.yc(o);if(n instanceof iE)i.push(o);else{let e=iI(n,l);null!=e&&(i.push(o),a.set(o,e))}}),new ig(a,new eE(i),s.fieldTransforms)}function iS(e,t,r,n,s,i){let a=e.Cc(1,t,r),o=[iA(t,n,r)],l=[s];if(i.length%2!=0)throw new A(b.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let e=0;e<i.length;e+=2)o.push(iA(t,i[e])),l.push(i[e+1]);let u=[],c=e4.empty();for(let e=o.length-1;e>=0;--e)if(!ix(u,o[e])){let t=o[e],r=l[e];r=(0,h.m9)(r);let n=a.yc(t);if(r instanceof iE)u.push(t);else{let e=iI(r,n);null!=e&&(u.push(t),c.set(t,e))}}return new ig(c,new eE(u),a.fieldTransforms)}function iI(e,t){if(iN(e=(0,h.m9)(e)))return ib("Unsupported field value:",t,e),iC(e,t);if(e instanceof iu)return function(e,t){if(!ip(t.Ac))throw t.Sc(`${e._methodName}() can only be used with update() and set()`);if(!t.path)throw t.Sc(`${e._methodName}() is not currently supported inside arrays`);let r=e._toFieldTransform(t);r&&t.fieldTransforms.push(r)}(e,t),null;if(void 0===e&&t.ignoreUndefinedProperties)return null;if(t.path&&t.fieldMask.push(t.path),e instanceof Array){if(t.settings.fc&&4!==t.Ac)throw t.Sc("Nested arrays are not supported");return function(e,t){let r=[],n=0;for(let s of e){let e=iI(s,t.wc(n));null==e&&(e={nullValue:"NULL_VALUE"}),r.push(e),n++}return{arrayValue:{values:r}}}(e,t)}return function(e,t){var r,n,s;if(null===(e=(0,h.m9)(e)))return{nullValue:"NULL_VALUE"};if("number"==typeof e)return r=t.serializer,"number"==typeof(s=n=e)&&Number.isInteger(s)&&!ed(s)&&s<=Number.MAX_SAFE_INTEGER&&s>=Number.MIN_SAFE_INTEGER?tU(n):tF(r,n);if("boolean"==typeof e)return{booleanValue:e};if("string"==typeof e)return{stringValue:e};if(e instanceof Date){let r=en.fromDate(e);return{timestampValue:rI(t.serializer,r)}}if(e instanceof en){let r=new en(e.seconds,1e3*Math.floor(e.nanoseconds/1e3));return{timestampValue:rI(t.serializer,r)}}if(e instanceof ih)return{geoPointValue:{latitude:e.latitude,longitude:e.longitude}};if(e instanceof io)return{bytesValue:rC(t.serializer,e._byteString)};if(e instanceof s9){let r=t.databaseId,n=e.firestore._databaseId;if(!n.isEqual(r))throw t.Sc(`Document reference is for database ${n.projectId}/${n.database} but should be for database ${r.projectId}/${r.database}`);return{referenceValue:rb(e.firestore._databaseId||t.databaseId,e._key.path)}}if(e instanceof ic)return{mapValue:{fields:{[eF]:{stringValue:ez},[eB]:{arrayValue:{values:e.toArray().map(e=>{if("number"!=typeof e)throw t.Sc("VectorValues must only contain numeric values.");return tF(t.serializer,e)})}}}}};throw t.Sc(`Unsupported field value: ${Z(e)}`)}(e,t)}function iC(e,t){let r={};return eg(e)?t.path&&t.path.length>0&&t.fieldMask.push(t.path):ef(e,(e,n)=>{let s=iI(n,t.mc(e));null!=s&&(r[e]=s)}),{mapValue:{fields:r}}}function iN(e){return!("object"!=typeof e||null===e||e instanceof Array||e instanceof Date||e instanceof en||e instanceof ih||e instanceof io||e instanceof s9||e instanceof iu||e instanceof ic)}function ib(e,t,r){if(!iN(r)||!J(r)){let n=Z(r);throw"an object"===n?t.Sc(e+" a custom object"):t.Sc(e+" "+n)}}function iA(e,t,r){if((t=(0,h.m9)(t))instanceof il)return t._internalPath;if("string"==typeof t)return iD(e,t);throw iR("Field path arguments must be of type string or ",e,!1,void 0,r)}let ik=RegExp("[~\\*/\\[\\]]");function iD(e,t,r){if(t.search(ik)>=0)throw iR(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,e,!1,void 0,r);try{return new il(...t.split("."))._internalPath}catch(n){throw iR(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,e,!1,void 0,r)}}function iR(e,t,r,n,s){let i=n&&!n.isEmpty(),a=void 0!==s,o=`Function ${t}() called with invalid data`;r&&(o+=" (via `toFirestore()`)"),o+=". ";let l="";return(i||a)&&(l+=" (found",i&&(l+=` in field ${n}`),a&&(l+=` in document ${s}`),l+=")"),new A(b.INVALID_ARGUMENT,o+e+l)}function ix(e,t){return e.some(e=>e.isEqual(t))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function iP(e,t,r){return e?r&&(r.merge||r.mergeFields)?e.toFirestore(t,r):e.toFirestore(t):t}class iF{constructor(e,t){this.hasPendingWrites=e,this.fromCache=t}isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}class iU extends iV{constructor(e,t,r,n,s,i){super(e,t,r,n,i),this._firestore=e,this._firestoreImpl=e,this.metadata=s}exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){let t=new iq(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(t,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,t={}){if(this._document){let r=this._document.data.field(iM("DocumentSnapshot.get",e));if(null!==r)return this._userDataWriter.convertValue(r,t.serverTimestamps)}}toJSON(){if(this.metadata.hasPendingWrites)throw new A(b.FAILED_PRECONDITION,"DocumentSnapshot.toJSON() attempted to serialize a document with pending writes. Await waitForPendingWrites() before invoking toJSON().");let e=this._document,t={};return t.type=iU._jsonSchemaVersion,t.bundle="",t.bundleSource="DocumentSnapshot",t.bundleName=this._key.toString(),e&&e.isValidDocument()&&e.isFoundDocument()&&(this._userDataWriter.convertObjectMap(e.data.value.mapValue.fields,"previous"),t.bundle=(this._firestore,this.ref.path,"NOT SUPPORTED")),t}}iU._jsonSchemaVersion="firestore/documentSnapshot/1.0",iU._jsonSchema={type:et("string",iU._jsonSchemaVersion),bundleSource:et("string","DocumentSnapshot"),bundleName:et("string"),bundle:et("string")};class iq extends iU{data(e={}){return super.data(e)}}class iz{constructor(e,t,r,n){this._firestore=e,this._userDataWriter=t,this._snapshot=n,this.metadata=new iF(n.hasPendingWrites,n.fromCache),this.query=r}get docs(){let e=[];return this.forEach(t=>e.push(t)),e}get size(){return this._snapshot.docs.size}get empty(){return 0===this.size}forEach(e,t){this._snapshot.docs.forEach(r=>{e.call(t,new iq(this._firestore,this._userDataWriter,r.key,r,new iF(this._snapshot.mutatedKeys.has(r.key),this._snapshot.fromCache),this.query.converter))})}docChanges(e={}){let t=!!e.includeMetadataChanges;if(t&&this._snapshot.excludesMetadataChanges)throw new A(b.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===t||(this._cachedChanges=function(e,t){if(e._snapshot.oldDocs.isEmpty()){let t=0;return e._snapshot.docChanges.map(r=>{let n=new iq(e._firestore,e._userDataWriter,r.doc.key,r.doc,new iF(e._snapshot.mutatedKeys.has(r.doc.key),e._snapshot.fromCache),e.query.converter);return r.doc,{type:"added",doc:n,oldIndex:-1,newIndex:t++}})}{let r=e._snapshot.oldDocs;return e._snapshot.docChanges.filter(e=>t||3!==e.type).map(t=>{let n=new iq(e._firestore,e._userDataWriter,t.doc.key,t.doc,new iF(e._snapshot.mutatedKeys.has(t.doc.key),e._snapshot.fromCache),e.query.converter),s=-1,i=-1;return 0!==t.type&&(s=r.indexOf(t.doc.key),r=r.delete(t.doc.key)),1!==t.type&&(i=(r=r.add(t.doc)).indexOf(t.doc.key)),{type:function(e){switch(e){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return I(61501,{type:e})}}(t.type),doc:n,oldIndex:s,newIndex:i}})}}(this,t),this._cachedChangesIncludeMetadataChanges=t),this._cachedChanges}toJSON(){if(this.metadata.hasPendingWrites)throw new A(b.FAILED_PRECONDITION,"QuerySnapshot.toJSON() attempted to serialize a document with pending writes. Await waitForPendingWrites() before invoking toJSON().");let e={};e.type=iz._jsonSchemaVersion,e.bundleSource="QuerySnapshot",e.bundleName=F.newId(),this._firestore._databaseId.database,this._firestore._databaseId.projectId;let t=[],r=[],n=[];return this.docs.forEach(e=>{null!==e._document&&(t.push(e._document),r.push(this._userDataWriter.convertObjectMap(e._document.data.value.mapValue.fields,"previous")),n.push(e.ref.path))}),e.bundle=(this._firestore,this.query._query,e.bundleName,"NOT SUPPORTED"),e}}iz._jsonSchemaVersion="firestore/querySnapshot/1.0",iz._jsonSchema={type:et("string",iz._jsonSchemaVersion),bundleSource:et("string","QuerySnapshot"),bundleName:et("string"),bundle:et("string")};class iB extends iO{constructor(e){super(),this.firestore=e}convertBytes(e){return new io(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new s9(this.firestore,null,t)}}function i$(e){e=ee(e,s6);let t=ee(e.firestore,is),r=ia(t),n=new iB(t);return(/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e){if("L"===e.limitType&&0===e.explicitOrderBy.length)throw new A(b.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}(e._query),(function(e,t,r={}){let n=new k;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,r,n,s){let i=new sG({next:r=>{i.Nu(),t.enqueueAndForget(()=>su(e,a)),r.fromCache&&"server"===n.source?s.reject(new A(b.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):s.resolve(r)},error:e=>s.reject(e)}),a=new sm(r,i,{includeMetadataChanges:!0,qa:!0});return sl(e,a)})(await sZ(e),e.asyncQueue,t,r,n)),n.promise})(r,e._query).then(r=>new iz(t,n,e,r)))}function ij(e,t,r,...n){e=ee(e,s9);let s=ee(e.firestore,is),i=iv(s);return iQ(s,[("string"==typeof(t=(0,h.m9)(t))||t instanceof il?iS(i,"updateDoc",e._key,t,r,n):iT(i,"updateDoc",e._key,t)).toMutation(e._key,tY.exists(!0))])}function iK(e){return iQ(ee(e.firestore,is),[new t8(e._key,tY.none())])}function iG(e,t){let r=ee(e.firestore,is),n=s7(e),s=iP(e.converter,t);return iQ(r,[i_(iv(e.firestore),"addDoc",n._key,s,null!==e.converter,{}).toMutation(n._key,tY.exists(!1))]).then(()=>n)}function iQ(e,t){return function(e,t){let r=new k;return e.asyncQueue.enqueueAndForget(async()=>sb(await sJ(e).then(e=>e.syncEngine),t,r)),r.promise}(ia(e),t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class iH{constructor(e,t){this._firestore=e,this._commitHandler=t,this._mutations=[],this._committed=!1,this._dataReader=iv(e)}set(e,t,r){this._verifyNotCommitted();let n=iW(e,this._firestore),s=iP(n.converter,t,r),i=i_(this._dataReader,"WriteBatch.set",n._key,s,null!==n.converter,r);return this._mutations.push(i.toMutation(n._key,tY.none())),this}update(e,t,r,...n){let s;this._verifyNotCommitted();let i=iW(e,this._firestore);return s="string"==typeof(t=(0,h.m9)(t))||t instanceof il?iS(this._dataReader,"WriteBatch.update",i._key,t,r,n):iT(this._dataReader,"WriteBatch.update",i._key,t),this._mutations.push(s.toMutation(i._key,tY.exists(!0))),this}delete(e){this._verifyNotCommitted();let t=iW(e,this._firestore);return this._mutations=this._mutations.concat(new t8(t._key,tY.none())),this}commit(){return this._verifyNotCommitted(),this._committed=!0,this._mutations.length>0?this._commitHandler(this._mutations):Promise.resolve()}_verifyNotCommitted(){if(this._committed)throw new A(b.FAILED_PRECONDITION,"A write batch can no longer be used after commit() has been called.")}}function iW(e,t){if((e=(0,h.m9)(e)).firestore!==t)throw new A(b.INVALID_ARGUMENT,"Provided document reference is from a different Firestore instance.");return e}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
